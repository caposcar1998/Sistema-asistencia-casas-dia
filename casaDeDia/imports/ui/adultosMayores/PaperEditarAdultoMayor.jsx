...
export default function PaperEditarAdultoMayor({ adultoMayorServidor,adultoSeleccionado, handleCerrarEditarAdultoMayor }) {
    ...
    useEffect(() => {
        ...
        setActividades(adultoSeleccionado.actividades);
        setRestricciones(adultoSeleccionado.restricciones);
        setHorarioApertura(adultoSeleccionado.horarioApertura);
        setHorarioCierre(adultoSeleccionado.horarioCierre);
        setCupoLimite(adultoSeleccionado.cupoLimite);
        ...
        return new Promise(
            (resolve, reject) => {
                Meteor.call("editarAdultoMayor",
                    adultoSeleccionado._id,nombre, direccion, actividades, restricciones, horarioApertura, horarioCierre, cupoLimite, codigoPostal, image,
                    (err, res) => {
                        if (err) {
                            setAlert("error")
