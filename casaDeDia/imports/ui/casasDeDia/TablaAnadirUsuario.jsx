...
import UsuariosCasaDeDia from './UsuariosCasaDeDia';
...
export default function TablaAnadirPersonal({ casasDeDiaServidor,casaSeleccionada, handleCerrarAnadirUsuario }) {
    ...
    function eliminarUsuario(idEliminar) {
        return new Promise(
            (resolve, reject) => {
                Meteor.call("borrarUsuarioDeCasa",
                    idEliminar,
                    (err, res) => {
                        if (err) {
                            setAlert("error")
        ...
        <>
            ...
            <TableContainer component={Paper}>
                <Table className={classes.table} aria-label="simple table">
                    ...
                    <TableBody>
                        {casaSeleccionada.usuarios.map((usuario) => (
                            <UsuariosCasaDeDia
                                usuario={usuario}
...
function CrearNuevoUsuario({ casasDeDiaServidor,casaSeleccionada, handleCerrarAnadirUsuario }) {
        ...
        return new Promise(
            (resolve, reject) => {
                Meteor.call("anadirAdulto",
                    casaSeleccionada._id, personaSeleccionada._id, personaSeleccionada.nombre, personaSeleccionada.curp,
                    (err, res) => {
                        if (err) {
                            setAlert("error")
                            setSnackBarState(true)
